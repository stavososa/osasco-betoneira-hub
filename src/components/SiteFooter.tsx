...
export function SiteFooter({ bairrosVisiveis }: { bairrosVisiveis?: typeof BAIRROS }) {
  return (
    <footer className="mt-20 border-t border-border bg-[var(--brand-navy)] text-white">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <section aria-labelledby="atendemos" className="mb-12">
          <h2 id="atendemos" className="font-display text-2xl uppercase">
        ...
        <div className="grid gap-8 border-t border-white/10 pt-8 md:grid-cols-3">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase text-[var(--brand-yellow)]">Contato</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase text-[var(--brand-yellow)]">Navegação</h3>
            <ul className="mt-2 space-y-1 text-sm">
