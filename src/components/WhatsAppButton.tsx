export function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/5511975465766?text=Ol%C3%A1!%20Gostaria%20de%20alugar%20uma%20betoneira%20em%20Osasco."
      target="_blank"
      rel="noopener"
      aria-label="Falar no WhatsApp"
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-2 ring-white transition-transform hover:scale-105"
    >
