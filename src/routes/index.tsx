  ...
  head: () => ({
    meta: [
      { title: "Aluguel de Betoneira em Osasco | Locação 120L, 150L, 250L e 400L" },
      {
        name: "description",
        content:
          "Aluguel e locação de betoneira em Osasco SP: modelos de 120, 150, 250 e 400 litros, elétricas 110V/220V e a gasolina. Entrega no mesmo dia, sem burocracia. WhatsApp (11) 97546-5766.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Aluguel e venda de betoneiras em Osasco e região: locação diária, semanal e mensal de misturadores de concreto e argamassa de 120, 150, 250 e 400 litros.",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Locação diária, semanal e mensal de betoneiras de 120, 150, 250 e 400 litros, elétricas 110V/220V e a gasolina, com entrega no mesmo dia em Osasco.",
        }),
      },
      {
        type: "application/ld+json",
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto grid min-h-[calc(100dvh-80px)] max-w-6xl items-center gap-10 px-4 py-16 md:grid-cols-[1fr_1fr] md:gap-16 md:py-0">
            ...
            <aside className="reveal relative" style={{ ["--i" as never]: 2 }}>
              <img
                ...
                width={720}
                height={780}
                className="relative z-10 mx-auto w-full max-w-3xl md:max-w-none lg:scale-[1.4] object-fill"
                loading="eager"
              />
            </aside>
          </div>
        ...
        <section className="mx-auto max-w-6xl px-4 py-24">
          ...
          <p className="reveal mt-4 max-w-2xl text-muted-foreground leading-relaxed">
            Betoneiras de 120, 150, 250 e 400 litros para aluguel em Osasco — versões elétricas monofásicas (110V/220V) e a gasolina — ideais para misturar concreto, argamassa, contrapiso e cimento em obras residenciais e de médio porte.
          </p>
