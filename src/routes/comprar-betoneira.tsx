...
const BENEFICIOS = [
  ...
  },
  {
    Icon: HelmetIcon,
    t: "Seminova revisada",
    d: "Equipamento usado, revisado e testado — preço acessível para começar a trabalhar agora.",
  },
  {
    Icon: ClockIcon,
  ...
  head: () => ({
    meta: [
      { title: "Comprar Betoneira em Osasco | Venda de Betoneira Nova e Seminova" },
      {
        name: "description",
        content:
          "Venda de betoneira em Osasco SP: novas e seminovas de 120, 150, 250 e 400 litros, elétricas 110V/220V e a gasolina, com garantia, nota fiscal e parcelamento. WhatsApp (11) 97546-5766.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Venda de betoneiras novas e seminovas em Osasco: 120, 150, 250 e 400 litros, elétricas 110V/220V e a gasolina, com garantia, nota fiscal e parcelamento.",
        }),
      },
      {
        type: "application/ld+json",
      ...
      <main className="flex-1">
        ...
        <section className="relative noise-overlay overflow-hidden bg-[var(--brand-navy)] text-white">
          <div className="mx-auto max-w-6xl px-4 py-20 md:py-28">
            ...
            <p className="reveal mt-6 max-w-2xl text-white/80 leading-relaxed" style={{ ["--i" as never]: 2 }}>
              Venda de betoneira nova e seminova em Osasco SP — modelos de 120, 150, 250 e 400 litros, elétricas 110V/220V e a gasolina, com garantia, nota fiscal e parcelamento. Atendemos pedreiro, empreiteiro e construtora.
            </p>
        ...
        <section className="mx-auto max-w-6xl px-4 py-20">
          ...
          <p className="reveal mt-4 max-w-2xl text-muted-foreground leading-relaxed">
            Trabalhamos com venda direta de betoneira nova e seminova para pedreiro, empreiteiro e construtora. Garantia, nota fiscal e suporte técnico — sem call center, falando direto com quem entrega o equipamento.
          </p>
        ...
        <section className="border-y-2 border-[var(--brand-ink)] bg-[var(--brand-concrete)] py-20">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <p className="reveal mt-4 max-w-2xl text-muted-foreground leading-relaxed">
              Preço de betoneira 120, 150, 250 e 400 litros — elétrica monofásica (110V/220V) ou a gasolina. Confira abaixo as faixas de preço de equipamentos novos e seminovos com garantia.
            </p>
