      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="reveal space-y-4 text-base text-foreground/90">
            ...
            <p>Trabalhamos com modelos de <strong>120L, 120L, 150L, 250L e 400L</strong>, elétricas e a gasolina, para atender desde pequenas reformas até obras de maior porte.</p>
          </div>
