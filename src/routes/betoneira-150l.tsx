...
export const Route = createFileRoute("/betoneira-150l")({
  head: () => ({
    meta: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          potentialAction: {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://wa.me/5511975465766?text=Quero%20alugar%20betoneira%20150l",
              "actionPlatform": [
  ...
  component: Betoneira150Page,
});

function Betoneira150Page() {
  useReveal();
  return (
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto grid min-h-[60vh] max-w-6xl items-center gap-10 px-4 py-16 md:grid-cols-[1fr_1fr] md:gap-16 md:py-0">
            <div className="relative">
              <nav aria-label="breadcrumb" className="reveal flex items-center gap-2 spec-label !text-white/70">
                ...
                <span className="text-[var(--brand-yellow)]">/ Betoneira 150L</span>
              </nav>
              <h1 className="reveal mt-4 font-display text-[3rem] leading-[0.92] tracking-tight md:text-[4.5rem]">
                Betoneira <span className="text-[var(--brand-yellow)]">150L</span> em Osasco
              </h1>
              <p className="reveal mt-6 max-w-md text-white/80 leading-relaxed">
                Aluguel de betoneira 150 litros em Osasco SP. Elétrica bivolt 110V/220V, motor 1/2 cv. Ideal para reformas pequenas, reboco, argamassa e contrapiso de cômodo. Entrega no mesmo dia, sem burocracia.
              </p>
              <div className="reveal mt-8 flex flex-wrap gap-4">
                <a href="https://wa.me/5511975465766?text=Quero%20alugar%20betoneira%20150L%20em%20Osasco" target="_blank" rel="noopener"
            ...
            <aside className="reveal relative flex items-center justify-center">
              <img src={betoneira150} alt="Betoneira 150 litros para reformas em Osasco" width={600} height={600} className="relative z-10 w-full max-w-sm object-contain" loading="eager" />
            </aside>
          </div>
        </section>
        <TrustBar />
        <section className="mx-auto max-w-6xl px-4 py-20">
          ...
          <div className="reveal mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { label: "Motor", value: "1/2 cv elétrico" },
              { label: "Voltagem", value: "110V / 220V bivolt" },
              { label: "Peso", value: "~70 kg" },
              { label: "Uso indicado", value: "Reformas pequenas" },
        ...
        <section className="bg-[var(--brand-concrete)] border-y-2 border-[var(--brand-ink)] py-20">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <h2 className="reveal mt-2 font-display text-3xl text-[var(--brand-ink)] md:text-5xl">Ideal para <span className="font-editorial text-[var(--brand-navy)]">reformas residenciais</span></h2>
            <ul className="reveal mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
              {["Reboco de parede", "Chapisco", "Emboço", "Contrapiso", "Argamassa", "Assentamento", "Reforma de cômodo", "Quintal pequeno"].map((a) => (
        ...
        <section className="relative noise-overlay bg-[var(--brand-yellow)] py-20">
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 text-center md:flex-row md:justify-between md:text-left">
            <div>
              ...
              <h2 className="mt-1 font-display text-3xl leading-tight text-[var(--brand-ink)] md:text-4xl">Aluguel de betoneira 150L em Osasco<br /><span className="font-editorial">com entrega no mesmo dia.</span></h2>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              <a href="https://wa.me/5511975465766?text=Quero%20alugar%20betoneira%20150L%20em%20Osasco" target="_blank" rel="noopener" className="inline-flex items-center gap-2 border-2 border-[var(--brand-ink)] bg-white px-6 py-3 text-sm font-bold uppercase tracking-wider text-[var(--brand-ink)] hard-shadow">WhatsApp <ArrowIcon size={16} /></a>
